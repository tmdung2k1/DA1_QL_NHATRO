...
@section('noidung')
    <div class="card" style="max-width: 600px; margin: auto;">
        <div class="card-body">
            <form action="{{ route('khachhang.update', $khachhang->Ma_khach_hang) }}" method="POST">
                {{-- csrf dung de bao mat form trong laravel --}}
                @csrf
                <div class="mb-3">
                    <label class="form-label">Họ và tên<span class="text-danger">*</span></label>
                    <input type="text" name="Ho_ten" class="form-control" value="{{ $khachhang->Ho_ten }}" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">CCCD<span class="text-danger">*</span></label>
                    <input type="text" name="Cccd" class="form-control" value="{{ $khachhang->Cccd }}" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="Que_quan" class="form-control" value="{{ $khachhang->Que_quan }}" required>
                </div>
